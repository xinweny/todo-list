...
const Controller = (() => {
	...
	const _filterThisWeek = date => (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(date);
	...
	const handleAddTodo = (title, dueDate, priority, group) => {
		...
		const project = ('projectId' in group) ? _Model_js__WEBPACK_IMPORTED_MODULE_0__["default"].getProject(group.projectId) : null;

		_Model_js__WEBPACK_IMPORTED_MODULE_0__["default"].createTodo(title, date, priority, project);
	...
	const handleEditTodo = (id, group, property, value) => {
		...
		_Model_js__WEBPACK_IMPORTED_MODULE_0__["default"].editTodo(id, property, newValue);
		_determineTodosRender(group);
	}
	...
	function onTodosChanged(todos) {
		...
		for (const todo of todos) {
			_View_js__WEBPACK_IMPORTED_MODULE_1__["default"].bindShowEditTodoTitleForm(todo);
			_View_js__WEBPACK_IMPORTED_MODULE_1__["default"].bindShowEditTodoDueDateForm(todo);
			_View_js__WEBPACK_IMPORTED_MODULE_1__["default"].bindToggleComplete(todo, handleToggleComplete);
			_View_js__WEBPACK_IMPORTED_MODULE_1__["default"].bindEditTodoTitle(todo.id, handleEditTodo);
			_View_js__WEBPACK_IMPORTED_MODULE_1__["default"].bindEditTodoDueDate(todo.id, handleEditTodo);
			_View_js__WEBPACK_IMPORTED_MODULE_1__["default"].bindEditTodoPriority(todo.id, handleEditTodo);
	...
	const _init = (function() {
		...
		_Model_js__WEBPACK_IMPORTED_MODULE_0__["default"].createTodo('a', new Date(), 'low', a);
		const b = _Model_js__WEBPACK_IMPORTED_MODULE_0__["default"].createTodo('e', new Date(), 'high');
...
const Model = (() => {
	...
	function createTodo(title, dueDate, priority, project) {
		const todo = (0,_Todo_js__WEBPACK_IMPORTED_MODULE_0__["default"])(title, dueDate, priority);
...
const View = (() => {
	...
	function _createTodoCard(todo) {
		...
		const formattedDate = (todo.dueDate) ? (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(todo.dueDate, "d LLL") : '';
