...
const Controller = (() => {
	...
	const handleAddTodo = (title, description, dueDate, priority, group) => {
		...
		_Model_js__WEBPACK_IMPORTED_MODULE_0__["default"].createTodo(title, description, date, priority, project);
	...
	const _init = (function() {
		...
		_Model_js__WEBPACK_IMPORTED_MODULE_0__["default"].createTodo('a', 'b', new Date(), 'low', a);
		const b = _Model_js__WEBPACK_IMPORTED_MODULE_0__["default"].createTodo('e', 'f', new Date(), 'high');
...
const View = (() => {
	...
	function _createTodoCard(todo) {
		...
		const formattedDate = (todo.dueDate) ? (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(todo.dueDate, 'd LLL yy @ HH:mm') : '';
