...
const Controller = (() => {
	const _filter = {
		...
		week: todo => (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(todo.dueDate)
	}
	...
	const handleAddTodo = (obj, group) => {
		...
		_Model_js__WEBPACK_IMPORTED_MODULE_0__["default"].createTodo(obj, project);
...
const Model = (() => {
	...
	_projects = _projects.map(e => (0,_Project_js__WEBPACK_IMPORTED_MODULE_1__["default"])(e));

	let _todos =  _getDataFromLocalStorage('todos', _initTodos());
	_todos = _todos.map(e => (0,_Todo_js__WEBPACK_IMPORTED_MODULE_0__["default"])(e));
