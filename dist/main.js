...
const Model = (() => {
	...
	_todos = _todos.map(e => _setPrototype(e, (0,_Todo_js__WEBPACK_IMPORTED_MODULE_0__["default"])())).map(_formatTodo);

	let _projects = _getDataFromLocalStorage('projects', []);
	_projects = _projects.map(e => _setPrototype(e, (0,_Project_js__WEBPACK_IMPORTED_MODULE_1__["default"])()));

	_setNextId((0,_Todo_js__WEBPACK_IMPORTED_MODULE_0__["default"])(), _getDataFromLocalStorage('nextTodoId', 0));
	_setNextId((0,_Project_js__WEBPACK_IMPORTED_MODULE_1__["default"])(), _getDataFromLocalStorage('nextProjectId', 0));
