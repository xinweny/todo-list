...
const Controller = (() => {
	...
	const handleEditTodo = (id, group, property, newTitle) => {
		_Model_js__WEBPACK_IMPORTED_MODULE_0__["default"].editTodo(id, property, newTitle);
		_determineTodosRender(group);
	}
	...
	function onTodosChanged(todos) {
		...
		for (const todo of todos) {
			_View_js__WEBPACK_IMPORTED_MODULE_1__["default"].bindShowEditTodoForm(todo);
			_View_js__WEBPACK_IMPORTED_MODULE_1__["default"].bindToggleComplete(todo, handleToggleComplete);
			_View_js__WEBPACK_IMPORTED_MODULE_1__["default"].bindEditTodoTitle(todo, handleEditTodo);
